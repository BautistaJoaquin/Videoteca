...
namespace challenge_NET.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PeliculaId,Imagen,Historia,FechaCreacion,Calificacion")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PeliculaId,Imagen,Historia,FechaCreacion,Calificacion")] Pelicula pelicula)
        {
